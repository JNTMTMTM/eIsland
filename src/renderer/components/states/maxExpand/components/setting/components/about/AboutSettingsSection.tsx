    ...
    <div className="max-expand-settings-section settings-about">
      ...
      <div className="settings-about-deps">
        ...
        <div className="settings-about-wallpaper-list">
          <div className="settings-about-row"><span className="settings-about-label">Artemis II</span><span className="settings-about-value">art002e008487~orig.jpg</span></div>
