...
export default sidebar({
  ...
  "/introduction/": [
    ...
    },
    {
      ...
      children: [
        ...
        "frontend-arch/questionnaire.md",
  ...
  "/api-plugins/": [
    ...
    {
      text: "Windows Hardware Info Helper",
      icon: "microchip",
      collapsible: true,
      children: [
        "system-power/hardware-info-helper/cpu-info.md",
        "system-power/hardware-info-helper/gpu-info.md",
        "system-power/hardware-info-helper/memory-slot-info.md",
        "system-power/hardware-info-helper/disk-info.md",
        "system-power/hardware-info-helper/network-adapter-info.md",
        "system-power/hardware-info-helper/bluetooth-device-info.md",
        "system-power/hardware-info-helper/motherboard-info.md",
        "system-power/hardware-info-helper/monitor-info.md",
        "system-power/hardware-info-helper/get-cpu-info.md",
        "system-power/hardware-info-helper/get-gpu-info.md",
        "system-power/hardware-info-helper/get-memory-info.md",
        "system-power/hardware-info-helper/get-disk-info.md",
        "system-power/hardware-info-helper/get-network-adapter-info.md",
        "system-power/hardware-info-helper/get-bluetooth-devices.md",
        "system-power/hardware-info-helper/get-motherboard-info.md",
        "system-power/hardware-info-helper/get-monitor-info.md",
      ],
    },
    {
    ...
    },
    {
      ...
      children: [
        ...
        "media-notifications/volume-analyzer/frequency-data.md",
        "media-notifications/volume-analyzer/amplitude-data.md",
        "media-notifications/volume-analyzer/beat-data.md",
        "media-notifications/volume-analyzer/audio-analysis-result.md",
        "media-notifications/volume-analyzer/analyzer-status.md",
        "media-notifications/volume-analyzer/command-result.md",
        "media-notifications/volume-analyzer/audio-process-info.md",
        "media-notifications/volume-analyzer/start.md",
        "media-notifications/volume-analyzer/start-ex.md",
        "media-notifications/volume-analyzer/stop.md",
        "media-notifications/volume-analyzer/get-result.md",
        "media-notifications/volume-analyzer/get-status.md",
        "media-notifications/volume-analyzer/start-polling.md",
        "media-notifications/volume-analyzer/stop-polling.md",
        "media-notifications/volume-analyzer/get-playing-processes.md",
      ],
    },
  ],
  "/api-backend/": [
